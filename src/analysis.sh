...
# go to local computer and prepare hairpin commands files
...
#     -n1 \
#     -J "SNV_merge" \
#     /lustre/scratch126/casm/team154pc/ms56/my_programs/INDEL_merge.sh $EXP_ID $ROOT_DIR
...
bsub -o $ROOT_DIR/log_files/mats_and_params.log.%J -e $ROOT_DIR/err_files/mats_and_params.err.%J \
    ...
    /lustre/scratch126/casm/team154pc/ld18/chemo/scripts/Mutation_filtering_get_parameters.R \
    -r $EXP_ID \
...
perl /lustre/scratch126/casm/team154pc/ld18/chemo/scripts/filter_for_bed_file.pl
...
bsub -o $ROOT_DIR/log_files/MSReduce.log.%J -e $ROOT_DIR/err_files/MSReduce.err.%J -q yesterday -R 'select[mem>=16000] span[hosts=1] rusage[mem=16000]' -M16000 -n1 -J MSreduce /lustre/scratch126/casm/team154pc/ld18/chemo/scripts/Reducing_mutset_from_MSfilters.R -r $EXP_ID -b $ROOT_DIR/hairpin/$MS_FILTERED_BEDFILE_NAME -d $MATS_AND_PARAMS_DIR
bsub -o $ROOT_DIR/log_files/MSReduce.log.%J -e $ROOT_DIR/err_files/MSReduce.err.%J -q yesterday -R 'select[mem>=16000] span[hosts=1] rusage[mem=16000]' -M16000 -n1 -J MSreduce /lustre/scratch126/casm/team154pc/ld18/chemo/scripts/Reducing_mutset_from_MSfilters.R -r $EXP_ID -b $ROOT_DIR/hairpin/$MS_FILTERED_BEDFILE_NAME -d $MATS_AND_PARAMS_DIR
...
#    /lustre/scratch126/casm/team154pc/ms56/my_programs/Sensitivity_analysis_from_SNPs.R \
#    -m $MATS_AND_PARAMS_DIR/mats_and_params_${EXP_ID}_postMS \
...
bsub -o $ROOT_DIR/log_files/sensitivity.log.%J -e $ROOT_DIR/err_files/sensitivity.err.%J \
    ...
    /lustre/scratch126/casm/team154pc/ld18/chemo/scripts/Sensitivity_analysis_from_SNPs.R \
    -m $MATS_AND_PARAMS_DIR/mats_and_params_${EXP_ID}_postMS \
    -o $ROOT_DIR -n sensitivity_analysis_${EXP_ID} \
    -i $ROOT_DIR/pindel_raw \
    -s $ROOT_DIR/hairpin/ \
...
#    -M4000 -n1 -J sensitivity \
#    /lustre/scratch126/casm/team154pc/ms56/my_programs/Sensitivity_analysis_from_SNPs.R \
#    -m $MATS_AND_PARAMS_DIR/mats_and_params_${EXP_ID} \
#    -o $ROOT_DIR -n sensitivity_analysis_${EXP_ID} \
#    -i $ROOT_DIR/pindel_raw \
...
#    /lustre/scratch126/casm/team154pc/ms56/my_programs/filtering_from_table_mix_remove.R \
#    -i ${RUN_ID_TB}_a_j \
#    -m /lustre/scratch126/casm/team154pc/ms56/chemo_exposed/filtering_runs/mats_and_params/mats_and_params_${RUN_ID_TB} \
#    -f pval \
#    -d $DONOR_ID \
#    -c 4 \
#    -o /lustre/scratch126/casm/team154pc/ms56/chemo_exposed/filtering_runs \
...
bsub -o $ROOT_DIR/log_files/treebuild.log.%J -e $ROOT_DIR/err_files/treebuild.err.%J \
    ...
    /lustre/scratch126/casm/team154pc/ld18/chemo/scripts/filtering_from_table_mix_remove.R \
    -i ${RUN_ID_TB}_a_j \
    -m /lustre/scratch126/casm/team154pc/ld18/chemo/filtering_runs/mats_and_params/mats_and_params_set1_postMS_reduced \
    -f pval \
    -d $DONOR_ID \
    -c 4 \
...
#bsub -o $ROOT_DIR/log_files/treebuild.log.%J -e $ROOT_DIR/err_files/treebuild.err.%J -q basement -R 'select[mem>=100000] span[hosts=1] rusage[mem=100000]' -M100000 -n1 -J tree_build /lustre/scratch126/casm/team154pc/ld18/chemo/scripts/filtering_from_table_mix_remove.R -i ${RUN_ID_TB}_a_j -m /lustre/scratch126/casm/team154pc/ms56/chemo_exposed/filtering_runs/mats_and_params/mats_and_params_${RUN_ID_TB} -f pval -d $DONOR_ID -c 4 -o $ROOT_DIR/filtering_runs -s $ROOT_DIR/sensitivity_analysis_${EXP_ID} -p -t $DONOR_AGE -j -a
